...
public class DeleteNextValue 
{
    ...
    void DeleteFromValue()
    {
        ...
        {            
            ...
            System.out.println("Enter the value you want to delete the next value");
    ...
    {
        DeleteNextValue obj = new DeleteNextValue();
        while(true)
        {
            System.out.println("\npress 1 for insert");
            System.out.println("press 2 for delete");
            System.out.println("press 3 for deleteFromLast");
            System.out.println("press 4 for delete Next Value");
