...
public class InsertSpecifiedValue 
{
    Nodee START;
    InsertSpecifiedValue()
    {
        START = null;
    }
    void addnode()
    ...
    {
        InsertSpecifiedValue obj = new InsertSpecifiedValue();
        while(true)
        {
            System.out.println("\npress 1 for insert");
            ...
            System.out.println("press 6 for traverse");
            System.out.println("press 7 for search");
